<template>
  <div class="text">
    <h2>ELMo</h2>During training ELMo tries to predict the following word looking at current and previous words - a task called Language Modeling.
    ...
    <br />
    <br />
    <h2>BERT</h2>(Bidirectional Encoder Representations from Transformers)
    <br />BERT is designed to pre-train deep bidirectional representations from unlabeled text by jointly conditioning on both left and right context in all layers.
